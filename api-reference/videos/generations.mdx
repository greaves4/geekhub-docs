...
<ParamField body="model" type="string" required>
  El ID namespaced del modelo, ej. `fal/hailuo-02`. Ver [Modelos video](/models/videos).
</ParamField>
...
<Tip>
  Antes de mandar muchos jobs en paralelo, calcula el techo: `duration × $/seg_proveedor × ~1.09`. Ejemplo: 10× Hailuo 5s ≈ `10 × 5 × $0.04 × 1.09 ≈ $2.18 USD`.
</Tip>
