...
<ParamField body="size" type="string">
  ...
  - Google / fal: `1024x1024`, `1024x768`, `768x1024`, etc. (según modelo)
</ParamField>
...
Cada imagen se cobra con la fórmula de [Facturación](/concepts/billing) (~1.09× el precio del proveedor). Ver [Modelos imágenes](/models/images).

Ejemplo: 1× Flux 1.1 Pro (`$0.04` proveedor) → sell ≈ **$0.044 USD** (ledger ≈ $0.87 MXN al FX 20).
